...
use App\Filament\Resources\Wedding8Resource\Pages;

class Wedding8Resource extends Resource
{
    protected static ?string $model = Wedding8::class;
                ...
                Wizard::make()->schema([
                    Step::make('Url')->schema([
                        TextInput::make('slug')->required()->maxLength(255)->label('Custom url')
                            ->prefix('http://127.0.0.1:8000/wedding8/'),
                    ...
                    Step::make('Acara')->schema([
                        ...
                        FileUpload::make('fotoSampul')
                            ->getUploadedFileNameForStorageUsing(function (TemporaryUploadedFile $file): string {
                                return (string) str($file->getClientOriginalName())->prepend('wedding8/');
    ...
    {
        return [
            'index' => Pages\ManageWedding8s::route('/'),
        ];
    }
}