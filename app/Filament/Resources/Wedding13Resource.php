...
use App\Filament\Resources\Wedding13Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Wedding13Resource\RelationManagers;
use App\Filament\Resources\Wedding13Resource\Pages\ManageWedding13s;

class Wedding13Resource extends Resource
{
    protected static ?string $model = Wedding13::class;
                ...
                Wizard::make()->schema([
                    Step::make('Url')->schema([
                        TextInput::make('slug')->required()->maxLength(255)->label('Custom url')
                            ->prefix('http://127.0.0.1:8000/wedding13/'),
                    ...
                    Step::make('Pengantin laki-laki')->schema([
                        ...
                        FileUpload::make('fotoPria')
                            ->getUploadedFileNameForStorageUsing(function (TemporaryUploadedFile $file): string {
                                return (string) str($file->getClientOriginalName())->prepend('wedding13/');
                    ...
                    Step::make('Acara')->schema([
                        ...
                        FileUpload::make('galery')->image()->multiple()->required()->maxFiles(6)->deleteUploadedFileUsing(function ($file) {
                            Storage::disk('public')->delete($file);
                        })->directory('wedding13')->label('Galery'),
    ...
    {
        return [
            'index' => Pages\ManageWedding13s::route('/'),
        ];
    }
}
