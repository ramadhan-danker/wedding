...
use App\Filament\Resources\Wedding11Resource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\Wedding11Resource\RelationManagers;

class Wedding11Resource extends Resource
{
    protected static ?string $model = Wedding11::class;
                ...
                Wizard::make()->schema([
                    Step::make('Url')->schema([
                        TextInput::make('slug')->required()->maxLength(255)->label('Custom url')
                            ->prefix('http://127.0.0.1:8000/wedding11/'),
                    ...
                    Step::make('Lain lain')->schema([
                        ...
                        FileUpload::make('galery')->image()->multiple()->required()->maxFiles(6)->deleteUploadedFileUsing(function ($file) {
                            Storage::disk('public')->delete($file);
                        })->directory('wedding11')->label('Galery'),
    ...
    {
        return [
            'index' => Pages\ManageWedding11s::route('/'),
        ];
    }
}
