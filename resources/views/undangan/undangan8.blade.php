...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/mahanta.css') }}" />
    <link rel="stylesheet" href="{{ asset('responsive/resmahanta.css') }}">
      ...
      background-size: cover;">
        <div class="male text-center">
          <div class="title">
            ...
            <h4>Bapak {{ $undangan->namaBapakPria }} <br> & <br> Ibu {{ $undangan->namaIbuPria }}</h4>
        ...
        <div class="female text-center">
          <div class="title">
            ...
            <h4>Bapak {{ $undangan->namaBapakPerempuan }} <br> & <br> Ibu {{ $undangan->namaIbuPerempuan }}</h4>
